...
if($_POST){
    if(!empty($_POST['nombre']) && !empty( $_POST['comentario'])){
      ...
      $fecha=date('Y-m-d');
     $conexion->query("INSERT INTO `messi es el mejor 10` (`ID`, `nombre`, `comentario`, `fecha`) VALUES (NULL, '$nombre','$comentario','$fecha')");
...
<div class="caja">
    ...
    <h1 class="encabezado">aca se discute si messi es el mejor 10</h1>

    <div class="formulario">
        <br>
        <form action="messi es el mejor 10.php" method="post" >
...
?>
<?php
$busca = $conexion->query("SELECT * FROM `messi es el mejor 10`");
